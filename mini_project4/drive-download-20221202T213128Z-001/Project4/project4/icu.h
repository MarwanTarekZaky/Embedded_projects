...
/*Description: ICU_init1() is the function that will initialize the ICU driver
 it takes a pointer to the configuration structure to properly initialize the clock and edge
 */
void ICU_init(const Icu_ConfigType * Config_Ptr);

/*Description: ICU_setCallBack function is the function used to determine which call back function
...
/*Description: ICU_setCallBack is a function used to set the type of edge that will be detected by the ICU (rising or falling)*/
void ICU_setEdgeDetectionType(const Icu_EdgeType edgeType);

/*Description: ICU_getInputCaptureValue is a function used to get the value stored in the ICR1 register*/
uint16 ICU_getInputCaptureValue(void);

/*Description: ICU_clearTimerValue is a function used to clear the TCNT1 register*/
void ICU_clearTimerValue(void);
/*Description: ICU_deInit() Function to disable the Timer1 to stop the ICU Driver*/
